<template>
  <Dialog modal header="Новый Клиент" :style="{ width: '30rem' }">
    ...
    />
    <inputInfo
      @updateInput="inputPhone = $event"
      :iconClass="'pi pi-phone'"
      :placeholder="'Телефон'"
    />
    <inputInfo
      @updateInput="inputTelegram = $event"
      :iconClass="'pi pi-telegram'"
      :placeholder="'Телеграм'"
    />
    <inputInfo
      @updateInput="inputVK = $event"
      :iconClass="'pi pi-mobile'"
      :placeholder="'ВК'"
    />
    <inputInfo
      @updateInput="inputAvito = $event"
      :iconClass="'pi pi-inbox'"
      :placeholder="'Авито'"
    />
    <inputInfo
      @updateInput="inputWhatsapp = $event"
